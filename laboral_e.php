...
echo "<tr bgcolor="yellow" width="100%"  height="35%" valign="top">";
echo count($x)." H"." "."Son las horas que tenemos de Fundamentos del Hardware"."<br>";
echo (count($y)*2)." H"." "."Son las horas que tenemos de Lenguajes de Marcas y Sistemas de Gestión de la Información" ;
foreach($x as $z){
	echo '<tr>'."<br>";
	// día año
	echo '<td>'."<br>";
